...
global u_genidwdm_splitbar_vertical u_genidwdm_splitbar_vertical
...
If KeyDown(keyLeftButton!) and il_prev_pos <> xpos Then
...
on u_genidwdm_splitbar_vertical.create
end on

on u_genidwdm_splitbar_vertical.destroy
end on
